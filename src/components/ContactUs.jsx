  ...
  return (
    <div className="container mx-auto py-12">
      ...
      <section className="relative bg-gray-900 text-white h-64 flex items-center justify-center mb-12" style={{ backgroundImage: 'url(https://via.placeholder.com/1500x400)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
        ...
        <h1 className="relative z-10 text-3xl sm:text-4xl md:text-5xl font-bold px-4 text-center">Contact Us</h1>
      </section>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 px-4">
        ...
        <div className="bg-white p-8 rounded-lg shadow-lg">
          ...
          <div className="space-y-4 text-gray-700 text-base sm:text-lg">
            <p><span className="font-semibold">Address:</span> 123, Sample Industrial Area, Hyderabad, Telangana</p>
            <p><span className="font-semibold">Phone:</span> +91 1234567890</p>
            <p><span className="font-semibold">Email:</span> info@shlokadrone.com</p>
            <p><span className="font-semibold">LinkedIn / Instagram:</span> Placeholder</p>
          </div>
        </div>

        {/* Right: Contact form */}
        <div className="bg-white p-8 rounded-lg shadow-lg">
          <h2 className="text-2xl sm:text-3xl font-bold mb-6 text-gray-800">Send us a Message</h2>
          <form className="space-y-6">
            ...
            <div>
              <label htmlFor="service" className="block text-base sm:text-lg font-medium text-gray-700">Service Needed</label>
              <select
                id="service"
                name="service"
                className="mt-1 block w-full px-4 py-2 sm:py-3 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 text-base sm:text-lg"
