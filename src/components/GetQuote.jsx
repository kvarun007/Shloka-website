  ...
  return (
    <div className="container mx-auto py-12">
      ...
      <section className="relative bg-gray-900 text-white h-64 flex items-center justify-center mb-12" style={{ backgroundImage: 'url(https://via.placeholder.com/1500x400)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
        ...
        <h1 className="relative z-10 text-3xl sm:text-4xl md:text-5xl font-bold px-4 text-center">Request a Custom Quote</h1>
      </section>

      {/* Quote Form */}
      <section className="bg-white p-6 sm:p-8 rounded-lg shadow-lg max-w-2xl mx-auto px-4">
        <h2 className="text-2xl sm:text-3xl font-bold mb-6 text-gray-800 text-center">Tell Us About Your Project</h2>
        <form className="space-y-6">
          <div>
            <label htmlFor="name" className="block text-base sm:text-lg font-medium text-gray-700">Name</label>
            <input
              type="text"
              id="name"
              name="name"
          ...
          <div>
            <label htmlFor="company" className="block text-base sm:text-lg font-medium text-gray-700">Company</label>
            <input
              type="text"
              id="company"
              name="company"
          ...
          <div>
            <label htmlFor="phone" className="block text-base sm:text-lg font-medium text-gray-700">Phone</label>
            <input
              type="tel"
              id="phone"
              name="phone"
          ...
          <div>
            <label htmlFor="location" className="block text-base sm:text-lg font-medium text-gray-700">Location</label>
            <input
              type="text"
              id="location"
              name="location"
          ...
          <div>
            <label htmlFor="service" className="block text-base sm:text-lg font-medium text-gray-700">Service</label>
            <select
              id="service"
              name="service"
              className="mt-1 block w-full px-4 py-2 sm:py-3 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 text-base sm:text-lg"
          ...
          <div>
            <label htmlFor="requirements" className="block text-base sm:text-lg font-medium text-gray-700">Requirements</label>
            <textarea
              id="requirements"
              name="requirements"
              rows="5"
          ...
          <div>
            <label htmlFor="fileUpload" className="block text-base sm:text-lg font-medium text-gray-700">File Upload (Optional)</label>
            <input
              type="file"
              id="fileUpload"
              name="fileUpload"
